...
const Home = () => {
  ...
  return (
    <div className="bg-white min-h-screen cursor-pointer">
      ...
      <div className="w-full h-10 bg-black mt-20">
          {isAuthenticated && user && <p className="text-white text-center items-center justify-center pt-2 font-sans font-thin">Welcome {user.name}</p>}
      </div>
