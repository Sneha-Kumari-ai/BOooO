        ...
        <div className="h-80 rounded-2xl border-2 border-gray-200 p-5">
          ...
          <div>
            <button
              ...
              className=" mt-6 font-sans font-thin text-xs border-2 border-black border-solid pt-2 pb-2 pl-44 pr-44 hover:rounded-3xl hover:bg-black hover:text-white duration-1000 ease-in-out"
            >
              LOGIN WITH REDIRECT
            </button>
